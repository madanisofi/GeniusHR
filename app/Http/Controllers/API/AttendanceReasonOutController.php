...
class AttendanceReasonOutController extends Controller
{
    public function reasonOut(Request $request)
    {
        $request->validate([
            'user_id'   => 'required',
        ...
        if (!empty($user)) {
            ...
            if (!empty($todayAttendance)) {
                ...
                $attendanceEmployee->status        = 'Pending';
                $attendanceEmployee->approve       = json_encode([]);
                $attendanceEmployee->notes         = $request->notes;
                $attendanceEmployee->clock_out     = $time;
                $attendanceEmployee->early_leaving = $earlyLeaving;
                $attendanceEmployee->overtime      = $overtime;
                $attendanceEmployee->images_out    = $fileNameToStore;
                ...
                $data = [
                    ...
                    "notification" => [
                        "title" => 'Presensi Logout Dari Luar',
                ...
                $notification->title        = 'Permintaan Logout Dari Luar';
    ...
    public function countingSalaryCuts($data)
    {
