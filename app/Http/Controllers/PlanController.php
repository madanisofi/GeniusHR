...
class PlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->can('Create Plan')) {
            ...
            if (Plan::create($post)) {
                return back()->with('success', __('Plan Successfully created.'));
            } else {
    ...
    public function plan_request($code)
    {
        ...
        if ($plan_request_check_user) {
            return back()->with('error', __('you already request sended for plan.'));
        } else {
            ...
            return back()->with('success', __('Plan request successfully sended.'));
        }
    }
