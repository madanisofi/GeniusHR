...
class ZoomMeetingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($meeting_create['success']) &&  $meeting_create['success'] == true) {
            ...
            $ZoomMeeting->save();
            return back()->with('success', __('Meeting created successfully.'));
        } else {
            return back()->with('error', __('Meeting not created.'));
        }
    }
    ...
    public function update(Request $request, ZoomMeeting $ZoomMeeting)
    {
        ...
        $ZoomMeeting->save();
        return back()->with('success', __('Zoom Meeting update Successfully'));
    }
    ...
    {
        $ZoomMeeting->delete();
        return back()->with('success', __('Zoom Meeting Delete Succsefully'));
    }
    ...
    public function calender()
    {
        ...
        $today_date = date('m');
        $current_month_event = ZoomMeeting::select('id', 'start_date', 'title', 'created_at')->whereMonth('start_date', '=', $today_date)->where('created_by', '=', Auth::user()->creatorId())->get();
