            ...
            <div class="form-group">
                ...
                <div class="choose-files ">
                    <label for="attachment">
                        ...
                        <img id="blah" alt="empty" width="100"
                            src="@if ($companyPolicy->attachment) {{ asset('uploads/companyPolicy/' . $companyPolicy->attachment) }}@else{{ asset('uploads/companyPolicy/user-2_1654779769.jpg') }} @endif" />
                    </label>
                </div>
            </div>
        </div>
