...
@section('action-button')
    @can('Create Company Policy')
        <a href="#" data-url="{{ route('company-policy.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create New Company Policy') }}" data-size="lg" data-bs-toggle="tooltip" title=""
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @foreach ($companyPolicy as $policy)
                                @php
                                    $policyPath = asset('uploads/companyPolicy');
                                @endphp
                                <tr>
                                        ...
                                        @if (!empty($policy->attachment))
                                            <div class="action-btn bg-primary ms-2">
                                                ...
                                                <a class="mx-3 btn btn-sm align-items-center"
                                                    href="{{ $policyPath . '/' . $policy->attachment }}" download="">
                                                    <i class="ti ti-download text-white"></i>
                                                </a>
                                            </div>
                                            <div class="action-btn bg-secondary ms-2">
                                                <a class="mx-3 btn btn-sm align-items-center"
                                                    href="{{ $policyPath . '/' . $policy->attachment }}" target="_blank">
                                                ...
                                                @can('Edit Company Policy')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" data-size="lg"
                                                            ...
                                                            title="" data-title="{{ __('Edit Company Policy') }}"
