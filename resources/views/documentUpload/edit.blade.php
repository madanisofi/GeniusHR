            ...
            <div class="form-group">
                ...
                <div class="choose-files ">
                    <label for="document">
                        ...
                        <img id="blah" class="mt-3" alt="empty" width="100"
                            src="@if ($ducumentUpload->document) {{ asset('uploads/documentUpload/' . $ducumentUpload->document) }} @else {{ asset('/uploads/uploadDocument/document.png') }} @endif" />
                    </label>
                </div>
            </div>
        </div>
