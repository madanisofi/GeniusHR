                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'HR department/Company to send complaints letter.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Dear ') . $complaints->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;">
                                                                            {{ __('I would like to report a conflict between you and the other person.There have been several incidents over the last few days, and I feel that it is time to report a formal complaint against him/her.') }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
