                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('birthplace', old('birthplace'), [
                                        'class' => 'form-control',
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('dob', null, ['class' => 'form-control d_week', 'required' => 'required', 'autocomplete' => 'off', 'placeholder' => 'Select Date of Birth']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="card em-card">
                        ...
                        <div class="card-body">
                            @foreach ($additionalInformation as $key => $additional)
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="additional" class="form-label">{{ $additional->name }}
                                            @if ($additional->is_required == 1)
                                                <span class="text-danger">*</span>
                                            @endif
                                        </label>
                                        <input type="hidden" name="additional_id[{{ $additional->id }}]" id=""
                                            value="{{ $additional->id }}">
                                        <input
                                            class="form-control {{ $additional->type == 'date' ? 'datepicker' : '' }}  @error('additional') is-invalid @enderror"
                                            @if ($additional->is_required == 1) required @endif
                                            name="additional[{{ $additional->id }}]" type="text"
                                            id="additional[{{ $additional->id }}]" style="width: 100%;">
                                    </div>
                                </div>
                            @endforeach
                        </div>
