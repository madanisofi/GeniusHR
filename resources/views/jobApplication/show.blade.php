            ...
            <div class="card-body">
                ...
                <h5 class="h4">
                    <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                        ...
                        <div>
                            <a href="{{ !empty($jobApplication->profile) ? asset('/uploads/job/profile/' . $jobApplication->profile) : asset('/uploads/avatar/avatar.png') }}"
                                target="_blank" class="avatar rounded-circle avatar-sm">
                                <img src="{{ !empty($jobApplication->profile) ? asset('/uploads/job/profile/' . $jobApplication->profile) : asset('/uploads/avatar/avatar.png') }}"
                    ...
                    <div class="col text-end">
                        <div class="col-12 text-end">
                            <a href="#" data-url="{{ route('job.on.board.create', $jobApplication->id) }}"
                                data-ajax-popup="true" class="btn-sm btn btn-primary"
                ...
                <div class="row">
                    ...
                    <div class="col text-end">
                        @can('Create Interview Schedule')
                            <a href="#" data-url="{{ route('interview-schedule.create', $jobApplication->id) }}"
