<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('shift.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('shift*') ? 'active' : '' }}">{{ __('Shift') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('roomtype.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('roomtype*') ? 'active' : '' }}">{{ __('Room Type') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('employeetype.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('employeetype*') ? 'active' : '' }}">{{ __('Employee Type') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('position.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('position*') ? 'active' : '' }}">{{ __('Position') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('group.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('group*') ? 'active' : '' }}">{{ __('Group') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('education.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('education*') ? 'active' : '' }}">{{ __('Education') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('additional.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('additional*') ? 'active' : '' }}">{{ __('Additional Information') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('permissiontype.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('permissiontype*') ? 'active' : '' }}">{{ __('Permission Type') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('compensation.index') }}"
            class="list-group-item list-group-item-action border-0 {{ request()->is('compensation*') ? 'active' : '' }}">{{ __('Overtime Compensation') }}
            <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
    </div>
</div>
