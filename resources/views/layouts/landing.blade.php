@php
    ...
    $company_logo_landing = Utility::GetLogolanding();
...
<head>
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'GeniusHR SaaS') }}
    </title>
    ...
    <meta name="author" content="PT. GIT Solution" />
...
<body class="{{ $color }}">
        ...
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                <img src="{{ $logos . '/' . (isset($company_logo_landing) && !empty($company_logo_landing) ? $company_logo_landing : 'logo-light.png') }}"
                    alt="{{ config('app.name', 'GeniusHR') }}" alt="logo" style="height: 40px; width: auto;">
            </a>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="{{ route('login') }}" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="https://codecanyon.net/item/GeniusHR-saas-hrm-and-payroll-tool/25982934"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <img src="{{ asset('landing/GeniusHR-saas-pic-1.png') }}" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/GeniusHR-saas-pic-1.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> All in one place GeniusHR SaaS
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
    ...
    <section id="price" class="price-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Price</span> All in one place GeniusHR SaaS
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    <p class="text-body"> {{ __('Copyright') }}
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'GeniusHR SaaS') }}
                        {{ date('Y') }} | Design By GeniusHR </p>
                </div>
            </div>
        </div>
