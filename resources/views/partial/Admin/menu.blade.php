...
<div class="navbar-wrapper">
    <div class="m-header main-logo">
        <a href="{{ route('home') }}" class="b-brand">
            <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') }}"
                alt="{{ config('app.name', 'GeniusHR') }}" style="height: 40px; width: auto;">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
                ...
                <ul class="dash-submenu ">
                    ...
                    @if (Gate::check('Manage Report'))
                        <li class="dash-item dash-hasmenu">
                            <a href="#!" class="dash-link"><span class=""><i class=""></i></span><span
                            ...
                            <ul class="dash-submenu">
                                @can('Manage Report')
                                    ...
                                    <li class="dash-item">
                                        <a class="dash-link"
                                            href="{{ route('report.employee.room') }}">{{ __('Room Details') }}</a>
                                    </li>

                                    <li class="dash-item">
                                        <a class="dash-link"
                                            href="{{ route('report.employee.position') }}">{{ __('Position Details') }}</a>
                                    </li>
                                @endcan
            ...
            @if (Auth::user()->type == 'super admin')
                <li class="dash-item">
                    <a href="{{ route('user.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-user"></i></span><span class="dash-mtext">{{ __('Company') }}</span></a>
                </li>
            @else
                @if (Gate::check('Manage User') ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            @endcan
                            @can('Manage Position Group')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('positiongroup.index') }}">{{ __('Position Group') }}</a>
                                </li>
                            @endcan
            ...
            @if (Gate::check('Manage Employee'))
                @if (Auth::user()->type == 'employee')
                    ...
                    <li class="dash-item {{ Request::segment(1) == 'employee' ? 'active' : '' }}">
                        <a href="{{ route('employee.show', Crypt::encrypt($employee->id)) }}" class="dash-link"><span
            ...
            @if (Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip'))
                <li
                    ...
                    <ul class="dash-submenu ">
                        ...
                        @can('Manage Counting')
                            <li class="dash-item {{ request()->is('counting*') ? 'active' : '' }}">
                                <a href="{{ route('counting.index') }}" class="dash-link">{{ __('Counting') }}</a>
                            </li>
                        @endcan
                        <li class="dash-item">
            ...
            {{-- Schedule --}}
            @can('Manage Schedule')
                <li class="dash-item  {{ Request::segment(1) == 'schedule' ? 'active' : '' }}">
                    <a href="{{ route('schedule.index') }}"
                        class="dash-link {{ request()->is('schedule*') ? 'active' : '' }}">
                        <span class="dash-micon"><i class="ti ti-calendar"></i></span><span
                            class="dash-mtext">{{ __('Schedule') }}</span>
                    </a>
                </li>
            @endcan
            ...
            @if (Gate::check('Manage Department') ||
                ...
                Gate::check('Manage Shift') ||
                Gate::check('Manage Room Type') ||
                Gate::check('Manage Employee Type') ||
                Gate::check('Manage Position') ||
                Gate::check('Manage Group') ||
                Gate::check('Manage Education') ||
                Gate::check('Manage Additional Information') ||
                Gate::check('Manage Permission Type') ||
                Gate::check('Manage Overtime Compensation'))
                <li class="dash-item dash-hasmenu">
