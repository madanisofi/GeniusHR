        ...
        <div class="col-lg-12 our-system">
            ...
            <div class="row">
                {{-- <ul class="nav nav-pills my-4">
                    <li class="nav-item">
                        <a data-toggle="tab" href="#allowance" class="nav-link active">{{__('Allowance')}}</a>
                    </li>
                    <li class="nav-item">
                        <a data-toggle="tab" href="#commission" class="nav-link">{{__('Commission')}}</a>
                    </li>
                    <li class="nav-item">
                        <a data-toggle="tab" href="#loan" class="nav-link">{{__('Loan')}}</a>
                    </li>
                    <li class="nav-item">
                        <a data-toggle="tab" href="#deduction" class="nav-link">{{__('Saturation Deduction')}}</a>
                    </li>
                    <li class="nav-item">
                        <a data-toggle="tab" href="#payment" class="nav-link">{{__('Other Payment')}}</a>
                    </li>
                    <li class="nav-item">
                        <a data-toggle="tab" href="#overtime" class="nav-link">{{__('Overtime')}}</a>
                    </li>
                </ul> --}}
