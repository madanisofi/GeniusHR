...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Manage Monthly Attendance') }}</li>
@endsection
@push('script-page')
...
@section('action-button')
    <a href="{{ route('report.attendance', [isset($_GET['month']) ? $_GET['month'] : date('Y-m'), isset($_GET['branch']) && !empty($_GET['branch']) ? $_GET['branch'] : 0, isset($_GET['department']) && !empty($_GET['department']) ? $_GET['department'] : 0]) }}"
        class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="" data-bs-original-title="Download">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <p class="text-muted text-sm mb-0">{{ $data['branch'] }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="text-muted text-sm mb-0">{{ $data['curMonth'] }}</p>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($attendance['status'] as $status)
                                                <td>
                                                    ...
                                                    @elseif($status == 'I')
                                                        <i class="badge bg-info p-2 rounded">{{ __('I') }}</i>
                                                    @elseif($status == 'A')
