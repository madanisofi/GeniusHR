...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Manage Payroll') }}</li>
@endsection
@push('script-page')
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center justify-content-end">
                    <div class="col-auto">
                        <div class="btn-box">
                            ...
                            <div class="d-flex radio-check">
                                <div class="cform-check form-check-inline form-group">
                    ...
                    <div class="col-auto mt-4">
                        ...
                        <a href="{{ route('report.payroll') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @foreach ($payslips as $payslip)
                                <tr>
                                    <td><a href="{{ route('employee.show', Crypt::encrypt($payslip->employee_id)) }}"
                                            class="btn btn-sm btn-primary">{{ !empty($payslip->employees) ? Auth::user()->employeeIdFormat($payslip->employees->employee_id) : '' }}</a>
                                    </td>
                                    ...
                                    <td>
                                        @if ($payslip->status == 0)
                                            <div class="badge badge-danger"><a href="#"
