                            ...
                            @can('Create Loan')
                                <div class="col text-end">
                                    <a href="#" data-url="{{ route('loans.create', $employee->id) }}"
                                        data-ajax-popup="true" data-title="{{ __('Create Loan') }}" data-bs-toggle="tooltip"
                                        title="" data-size="lg" class="btn btn-sm btn-primary"
                                        data-bs-original-title="{{ __('Create') }}">
                                        <i class="ti ti-plus"></i>
                                    </a>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h5>{{ __('Consumption Fee') }} (+)</h5>

                            </div>
                            @can('Create Set Salary')
                                <div class="col-6 text-end">

                                    <a href="#" data-url="{{ route('employee.consumption.fee', $employee->id) }}"
                                        data-ajax-popup="true" data-title="{{ __('Set Consumption Cost') }}"
                                        data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                        data-bs-original-title="{{ __('Set Consumption') }}">
                                        <i class="ti ti-plus"></i>
                                    </a>
                    ...
                    <div class="card-body">
                        <div class="project-info d-flex text-sm">
                            <div class="project-info-inner mr-3 col-6">
                                <b class="m-0"> {{ __('Daily Consumption Fee') }} </b>
                                <div class="project-amnt pt-1">
                                    {{ Auth::user()->priceFormat($employee->consumption_fee) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h5>{{ __('Guard Bonus') }} (+)</h5>
                            </div>
                            @can('Create Guard Bonus')
                                <div class="col text-end">
                                    <a href="#" data-url="{{ route('payshifts.create', $employee->id) }}"
                                        data-ajax-popup="true" data-title="{{ __('Create Guard Bonus') }}"
                                        data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                        data-bs-original-title="{{ __('Create') }}">
                                        <i class="ti ti-plus"></i>
                                    </a>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($payshift as $payshift)
                                        <tr>
                                            <td>{{ !empty($payshift->employee()) ? $payshift->employee()->name : '' }}</td>
                                            <td>{{ !empty($payshift->shift()) ? $payshift->shift()->name : '' }}</td>
                                            <td>{{ Auth::user()->priceFormat($payshift->amount) }}</td>
                                            <td class="Action">
                                                <span>
                                                    @can('Edit Guard Bonus')
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                                data-url="{{ URL::to('payshift/' . $payshift->id . '/edit') }}"
                                                                data-ajax-popup="true" data-size="md"
                                                                data-bs-toggle="tooltip" title=""
                                                                data-title="{{ __('Edit Guard Bonus') }}"
                                                                data-bs-original-title="{{ __('Edit') }}">
                                                                <i class="ti ti-pencil text-white"></i>
                                                            </a>
                                                        </div>
                                                    @endcan
                                                    @can('Delete Guard Bonus')
                                                        <div class="action-btn bg-danger ms-2">
                                                            {!! Form::open([
                                                                'method' => 'DELETE',
                                                                'route' => ['payshift.destroy', $payshift->id],
                                                                'id' => 'delete-form-' . $payshift->id,
                                                            ]) !!}
                                                            <a href="#"
                                                                class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                                                data-bs-toggle="tooltip" title=""
