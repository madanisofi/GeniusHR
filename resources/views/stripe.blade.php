...
@push('scripts')
    ...
    @if (!empty($admin_payment_setting['is_paystack_enabled']) &&
    ...
    @if (!empty($admin_payment_setting['is_flutterwave_enabled']) &&
                            ...
                            callback: function(response) {
                                ...
                                if (
                                    ...
                                    window.location.href = flutter_callback + '/' + txref + '/' +
                                        '{{ Crypt::encrypt($plan->id) }}?coupon_id=' +
                                        coupon_id;
                                } else {
    ...
    @if (!empty($admin_payment_setting['is_razorpay_enabled']) &&
...
@php
    $dir = asset('uploads/plan');
    $dir_payment = asset('uploads/payments');
                    ...
                    <div class="sticky-top">
                        <div class="card">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                ...
                                @endif
                                @if (isset($admin_payment_setting['is_flutterwave_enabled']) &&
                                    $admin_payment_setting['is_flutterwave_enabled'] == 'on')
                                    <a class="list-group-item list-group-item-action border-0" data-toggle="tab"
                                ...
                                @endif
                                @if (isset($admin_payment_setting['is_razorpay_enabled']) &&
                                    $admin_payment_setting['is_razorpay_enabled'] == 'on')
                                    <a class="list-group-item list-group-item-action border-0" data-toggle="tab"
                                ...
                                @endif
                                @if (isset($admin_payment_setting['is_coingate_enabled']) &&
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group"><label for="flaterwave_coupon"
                                                        class="form-label">{{ __('Coupon') }}</label></div>
                                                <div class="row align-items-center">
                                                    <div class="col-md-11">
                                                        <div class="form-group">
                                                ...
                                                <div class="paytm-payment-div">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-5">
                                                            <div class="form-group">
                                                                <label for="paytm_coupon"
                                                                    class="form-label text-dark mb-4">{{ __('Mobile Number') }}</label>
                                                        ...
                                                        <div class="col-5">
                                                            <div class="form-group">
                                                                <label for="paytm_coupon"
                                                                    class="form-label text-dark mb-4">{{ __('Coupon') }}</label>
