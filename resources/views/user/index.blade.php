        ...
        @foreach ($users as $user)
            <div class="col-xl-3">
                <div class="card  text-center">
                    ...
                    <div class="card-body">
                        <div class="avatar">
                            <a href="{{ !empty($user->avatar) ? asset('uploads/avatar/' . $user->avatar) : asset('uploads/avatar/avatar.png') }}"
                                target="_blank">
                                <img src="{{ !empty($user->avatar) ? asset('uploads/avatar/' . $user->avatar) : asset('uploads/avatar/avatar.png') }}"
                        ...
                        @if (Auth::user()->type == 'super admin')
                            ...
                            <p class="mt-2 mb-0">
                                <button class="btn btn-sm btn-neutral mt-3 font-weight-500">
                                    <a>{{ __('Plan Expire : ') }}
                                        {{ !empty($user->plan_expire_date) ? $user->dateFormat($user->plan_expire_date) : 'Unlimited' }}</a>
                                </button>
                            </p>
                        @endif
                    </div>
